    ...
    <section class="section" id="trainers">
        <div class="container">
            ...
            <div class="contact-form">
                <form action="carres.php" method="post" id="contact">
                    <div class="row">
                    ...
                    <div class="part1 wrap">
                        <div class="part1 search">
                            <input type="text" class="part1 searchTerm" placeholder="What are you looking for?" name="srch">
                            <button type="submit" name="submit" class="part1 searchButton ">
