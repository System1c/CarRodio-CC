                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10">Edit Advertisement</h5>
                                        <p class="m-b-0">Edit your new advertisement</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">Edit Advertisement</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <form action="assets/php/updAd.php" method="post" enctype="multipart/form-data">
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Ad Title</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control"  name="adtit" value="<?php print $tit ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Select Condition of the Vehicle</label>
                                                            <div class="col-sm-10">
                                                                <select name="cond" class="form-control" value="<?php print $cond ?>">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select name="ctype" class="form-control" value="<?php print $stype ?>">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Enter Brand of the Vehicle" name="brand" value="<?php print $brd ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Description</label>
                                                            <div class="col-sm-10">
                                                                <textarea class="form-control" placeholder="Please enter the Description of the Vehicle" name="descr" required><?php print $disc ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Mileage</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Enter Mileage of the Vehicle" name="mlg" value="<?php print $mile ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Price</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Enter the price of the Vehicle" name="dprice" value="<?php print $oprc ?>"required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Discount Price</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Enter the discounted price of the Vehicle" name="price" value="<?php print $prc ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                        ...
                                                        <button  type="submit" class="btn btn-success waves-effect waves-light " name="update" ><i class="icofont icofont-check-circled"></i>Update Advertisement</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
