...
if ($err == "false") {
    $err == "false";
    include("assets/php/sigadmin.php");
    if ($status == "true"){
...
<head>
    <title>Add New Administrator - Admin</title>
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form action="newad.php" method="post">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" placeholder="Password" name="pswr" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
