...
class highreads extends FPDF
{
    ...
    {
        $this->SetFont('Times', '', 12);
        $stmt = $db->query('select id, title, vcondition, type, brand, price, sellerid, postdate, mileage from advert where status="v" order by clk desc ');
